...
#
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/ubuntu/70-davinci.rules:system/halium/lib/udev/rules.d/70-android.rules \
    $(LOCAL_PATH)/ubuntu/davinci.conf:system/halium/etc/ubuntu-touch-session.d/android.conf \
